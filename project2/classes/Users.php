...
//     $roleid = $data['roleid'];
    ...
    if ( $username == "" || $email == ""|| $first_name == ""|| $last_name == ""
     || $country_origin == ""  || $marital_status == "" || $num_kids == "" || $password == "") {
...
<strong>Error !</strong> Your Password Must Contain At Least 1 Number !</div>';
      ...
      $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
<strong>Error !</strong> Your Password Must Contain At Least 1 Lower Case !</div>';
        return $msg;
   }elseif(!preg_match("#[A-Z]+#",$password)) {
       $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
     <strong>Error !</strong> Your Password Must Contain At Least 1 Upper Case !</div>';
         return $msg;
    }elseif(!preg_match("/[^A-Za-z0-9]/",$password)) {
            $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
         <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
         <strong>Error !</strong> Your Password Must Contain At Least 1 Special Character !</div>';
             return $msg;
...
<strong>Error !</strong> Email already Exists, please try another Email... !</div>';
      ...
      $sql = "INSERT INTO tbl_users(username, password,email,first_name, last_name, country_origin,marital_status,
      num_kids) VALUES(:username, :password, :email, :first_name, :last_name,:country_origin,:marital_status,
      :num_kids)";
      $stmt = $this->db->pdo->prepare($sql);
      ...
      $stmt->bindValue(':num_kids', $num_kids);
...
//           return $msg;
  ...
  public function addNewUserByAdmin($data){
    ...
    if ( $username == "" || $email == "" || $password == ""|| $first_name == ""|| $last_name == ""
         || $country_origin == ""  || $marital_status == "" || $num_kids == "") {
      $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
...
<strong>Error !</strong> Username is too short, at least 3 Characters !</div>';
      ...
      $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
<strong>Error !</strong> Password at least 8 Characters !</div>';
        return $msg;
    }elseif(!preg_match("#[0-9]+#",$password)) {
      $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
...
<strong>Error !</strong> Email already Exists, please try another Email... !</div>';
    ...
    $sql = "INSERT INTO tbl_users(username, password,email,first_name, last_name, country_origin,marital_status,
          num_kids,roleid) VALUES(:username, :password, :email, :first_name,:last_name,:country_origin,:marital_status,
          :num_kids,:roleid)";
          $stmt = $this->db->pdo->prepare($sql);
          $stmt->bindValue(':username', $username);
          $stmt->bindValue(':password', SHA1($password));
